...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/presentation/public/libs/css/bootstrap.min.css"/>
        ...
        <link href="/presentation/public/css/header.css" rel="stylesheet" type="text/css"/>
        <link href="/presentation/public/css/site.css" rel="stylesheet" type="text/css"/>

        <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
        <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script>
        <script src="/presentation/public/libs/js/bootstrap.min.js" type="text/javascript"></script>

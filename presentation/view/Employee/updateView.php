        ...
        <div class="card-body">
            ...
            <form id="insert-form">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="type" name="type" onchange="switchVisibilityToShow('#position-container')" required>
                        <option selected disabled>Seleccione una opción</option>
                ...
                <div id="position-container" class="form-group"> <script>switchVisibilityToHide('#position-container');</script>
                    <label for="id_position">Puesto</label>
                    <select class="form-control" id="gender" name="gender" required>
                        <option selected disabled>Seleccione una opción</option>
                        <option value="0">Cargar Puestos</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="liquidated" name="liquidated" value="1" onchange="switchVisibility('#observations-container')">
                        <label class="form-check-label" for="defaultCheck1">
                            Liquidado
                        </label>
                    </div>
                ...
                <div id="observations-container" class="form-group"> <script>switchVisibilityToHide("#observations-container")</script>

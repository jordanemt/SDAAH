        ...
        <div class="body">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 14%; text-align: center;" class="border"><?= date('d-m-Y', strtotime($data['departureDate'])); ?></td>
                </tr>
            </table>
                ...
                foreach ($data['vacations']['fortnight'] as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td style="width: 40%; text-align: center;" class="border">
                            ...
                            <?= number_format($data['vacations']['accruing'][$key], 2, '.', ' '); ?>
                        </td>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['vacations']['salaryTotal'], 2, '.', ' '); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['vacations']['avgSalary'], 2, '.', ' '); ?>
                    </td>
                    <td style="width: 20%;"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['vacations']['accruedVacation'], 2, '.', ' '); ?>
                    </td>
                    <td style="width: 20%;"></td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['netVacation'], 2, '.', ' '); ?>
                    </td>
                </tr>
            </table>
            ...
            <table>
                ...
                foreach ($data['preCen']['fortnight'] as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td style="width: 40%; text-align: center;" class="border">
                            <img src="<?= $currencyPath ?>" height="12">
                            <?= number_format($data['preCen']['accruing'][$key], 2, '.', ' '); ?>
                        </td>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['preCen']['salaryTotal'], 2, '.', ' '); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['preCen']['avgSalary'], 2, '.', ' '); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['preCen']['totalPre'], 2, '.', ' '); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['preCen']['totalCen'], 2, '.', ' '); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 40%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['preCen']['totalPreCen'], 2, '.', ' '); ?>
                    </td>
                    <td style="width: 20%;"></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 60%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['totalSalariesBonus'], 2, '.', ' '); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 60%; text-align: center;" class="border">
                        <img src="<?= $currencyPath ?>" height="12">
                        <?= number_format($data['totalBonus'], 2, '.', ' '); ?>
                    </td>
                </tr>
            </table>

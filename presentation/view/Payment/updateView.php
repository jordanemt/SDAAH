            ...
            <form id="form">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control numberMask" id="workingDays" name="workingDays" 
                               value="<?= $vars['data']['workingDays'] ? $vars['data']['workingDays'] : ''?>"
                               <?= ($vars['data']['employee']['position']['type'] == 'Mensual') ? '' : 'disabled' ?> required>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="ordinaryTimeHours">Horas Ordinarias</label>
                        <input type="text" class="form-control numberMask" id="ordinaryTimeHours" name="ordinaryTimeHours" 
                               value="<?= $vars['data']['ordinaryTimeHours'] ? $vars['data']['ordinaryTimeHours'] : '' ?>"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control numberMask" id="extraTimeHours" name="extraTimeHours" 
                               value="<?= $vars['data']['extraTimeHours'] ? $vars['data']['extraTimeHours'] : '' ?>">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control numberMask" id="doubleTimeHours" name="doubleTimeHours" 
                               value="<?= $vars['data']['doubleTimeHours'] ? $vars['data']['doubleTimeHours'] : '' ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control numberMask" id="vacationsDays" name="vacationsDays" 
                               value="<?= $vars['data']['vacationsDays'] ? $vars['data']['vacationsDays'] : '' ?>">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control moneyMask" id="vacationAmount" name="vacationAmount" 
                               value="<?= $vars['data']['vacationAmount'] != 0 ? $vars['data']['vacationAmount'] : '' ?>">
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control numberMask" id="INSDamaternityDaysys" name="maternityDays" 
                               value="<?= $vars['data']['maternityDays'] ? $vars['data']['maternityDays'] : '' ?>">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control moneyMask" id="maternityAmount" name="maternityAmount" 
                               value="<?= $vars['data']['maternityAmount'] != 0 ? $vars['data']['maternityAmount'] : '' ?>">
                    </div>
                </div>

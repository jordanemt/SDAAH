                ...
                <tbody>
                    ...
                    foreach ($vars['data'] as $value) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="?controller=user&action=updateView&id=<?= $value['id'] ?>" class=""><i class="fa fa-edit"></i> Editar</a>
                                <a href="#" class="font-warning" onclick="removeUser(<?= $value['id'] ?>);"><i class="fa fa-trash-alt"></i> Eliminar</a>
                            </td>
                        </tr>
                        <?php
                    }
